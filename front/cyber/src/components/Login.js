    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center px-4">
      <div className="max-w-md w-full bg-gray-800 rounded-lg border border-green-500 p-8 space-y-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-green-500 font-mono">Login</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            <Link to="/forgot-password" className="text-green-500 hover:text-green-400 text-sm font-mono">
              Forgot Password?
            </Link>
            <Link to="/signup" className="text-green-500 hover:text-green-400 text-sm font-mono">
              Create Account
            </Link>
          </div>
